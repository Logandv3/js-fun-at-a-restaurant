...
if (isFavorite === true) {
  ...
  console.log("I recently are [food].");
};
*/
...
var vegetables = ["potato","radish","pumpkin","squash","carrot"];
...
// different fruits.
var fruits = ["passion fruit","water melon","kiwi","grapes","strawberry","raspberry","loganberry",];
